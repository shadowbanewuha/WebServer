...
require_once './sdk/model/AlipayTradePrecreateRequest.php';
require_once './sdk/aop/AopClient.php';
require_once './sdk/model/AlipayF2FPrecreateResult.php';
...
class AlipayTradeService {
	...
	function create_erweima($content, $size = '200', $lev = 'L', $margin= '0') {
		...
		$image = '<img src="http://qr.liantu.com/api.php?text='.$content .'" style= width:200px;/>';
		return $image;
	}
